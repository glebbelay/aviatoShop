		...
		<div className="row">
			<div className="col-md-3">
				<div className="team-member text-center">
					<img className="img-circle" src="images/team/team-1.jpg"></img>
			...
			<div className="col-md-3">
				<div className="team-member text-center">
					<img className="img-circle" src="images/team/team-2.jpg"></img>
			...
			<div className="col-md-3">
				<div className="team-member text-center">
					<img className="img-circle" src="images/team/team-3.jpg"></img>
					<h4>John Fexit</h4>
					<p>Shop Manager</p>
				</div>
			</div>
